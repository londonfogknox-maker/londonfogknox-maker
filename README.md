...
Architecting prototypes from the ground up— frontend, backend, and API to make web tools and browser-based games born from after-work boredem.
...
| :--- | :--- |
| • **Frontend:** Next.js, Tailwind CSS | • **Frontend:** Vanilla HTML, CSS, TS |
